...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Enregistrer l'accès<br/>Essai de connection au réseau.<br />Si échec, merci de vous reconnecter à nouveau.</div>";
...
const char HTTP_STATUS_OFF[]       PROGMEM = "<div class='msg {c}'><strong>Non connecté</strong> to {v}{r}</div>"; // {c=class} {v=ssid} {r=status_off}
...
const char S_exiting[]            PROGMEM = "Sortie...";
const char S_resetting[]          PROGMEM = "Le module va redemarrer dans quelques secondes.";
const char S_closing[]            PROGMEM = "Vous pouvez fermer la page le portail reste ouvert";
const char S_error[]              PROGMEM = "Une erreure est apparue";
const char S_notfound[]           PROGMEM = "Fichier non trouvé\n\n";
