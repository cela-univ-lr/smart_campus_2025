...
#define LUMINOSITE_PIN               1  // Broche analogique pour le capteur de luminosité Grove Light Sensor
#define LUMINOSITE_INTERVAL_MS    2000  // Intervale de temps de la boucle infinie du capteur luminosité en ms 
